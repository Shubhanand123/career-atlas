...
export default function CareerUniverse({ scrollProgress = 0, onNodeClick, onSelectCategory }) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '580px', borderRadius: '18px', overflow: 'hidden', border: '1px solid var(--border-subtle)' }}>
      <Canvas 
